...
@section('content')
<!-- Vehicle Hero -->
<div class="position-relative overflow-hidden location-hero">
            ...
            <div class="text-white">
                <div class="mb-3">
                    @if($vehicle->is_available)
                        <span class="hero-pill">Available</span>
                    @else
                        <span class="hero-pill">Not Available</span>
                    @endif
                    @if($vehicle->has_ac)
                        <span class="hero-pill">AC Available</span>
                    @endif
                </div>
                <h1 class="hero-title mb-3">{{ $vehicle->name }}</h1>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="content-card mb-4">
                <div>
                    <h3 class="section-title mb-4"><i class="bi bi-gear me-2"></i>Specifications</h3>
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="d-flex align-items-center p-3 rounded vehicle-spec-box">
                                <i class="bi bi-people-fill fs-3 vehicle-spec-icon me-3"></i>
                                <div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center p-3 rounded vehicle-spec-box">
                                <i class="bi bi-bag-fill fs-3 vehicle-spec-icon me-3"></i>
                                <div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center p-3 rounded vehicle-spec-box">
                                <i class="bi bi-wind fs-3 vehicle-spec-icon me-3"></i>
                                <div>
            ...
            @if($vehicle->features)
                <div class="content-card mb-4">
                    <div>
                        <h3 class="section-title mb-3"><i class="bi bi-star text-warning me-2"></i>Features & Amenities</h3>
                        <div class="row g-3">
            ...
            <div class="content-card">
                <div>
                    <h3 class="section-title mb-4">Why Choose This Vehicle?</h3>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="d-flex">
            ...
            <div class="content-card my-4">
                <div>
                    ...
                    <div class="prose-content content-html">{!! $vehicle->description !!}</div>
                </div>
            </div>
...
<style>
    .vehicle-spec-box { background: linear-gradient(135deg, #f3f8ff, #f8fbff); border: 1px solid #dce9ff; }
    .vehicle-spec-icon { color: #0d6efd; }
</style>
@endsection
